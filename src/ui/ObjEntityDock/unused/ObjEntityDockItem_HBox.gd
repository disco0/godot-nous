class_name ObjEntityDockItem_HBox
...
#		extractor_label.text = extractor.extractor_type # EntityMeshExtractors.TrimSuffix((extractor as EntityMeshExtractor).extractor_name)
